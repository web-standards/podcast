...
1. Создайте новый эпизод, где `N` — номер эпизода:
	...
	На основе шаблонов [index.yml](src/templates/index.yml) и [index.md](src/templates/index.md) в папке `src/episodes/N` появятся файлы эпизода.
...
7. Заполните метаданные в файле `index.yml`
	...
	- Скопируйте названия глав из файла `index.txt`.

8. Обновите ссылки в файле `index.md`:

	- Скопируйте главы и замените таймкоды на заголовки второго уровня.
...
11. Соберите и задеплойте сайт и фид:
